...
Taken from https://github.com/sujitpal/nltk-examples/blob/master/src/semantic/short_sentence_similarity.py
(just adapted to work on Python 3)
    ...
    if len(synsets_1) == 0 or len(synsets_2) == 0:
        ...
        for synset_1 in synsets_1:
            for synset_2 in synsets_2:
               sim = wn.path_similarity(synset_1, synset_2, simulate_root=True)
...
def word_order_similarity(sentence_1, sentence_2):
    ...
    """
    # Avoid NaNs for identical sentences with a single word
